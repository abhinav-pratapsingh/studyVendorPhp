...
<body>
    ...
    <main>
        <section class="herosec-con mb-0">
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-lg-6">
                            ...
                            <p class="mt-3">Whether you’re seeking a semester exchange, a summer program, or a full degree abroad, we’re here to guide you every step of the way.</p>

                            <div class="d-flex gap-sm-3 align-items-center flex-wrap">
                                <a href="https://careertest.edumilestones.com/student-profiler/?channel_id=MzMxOQ==" target="_blank"><button class="btn-one">Find my perfect academic fit <i
        ...
        <section class="bg-gray">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <img src="img/about/about.webp" class="img-fluid" alt="" />
                    </div>
                    ...
                    <div class="col-lg-7">
                        ...
                        <p class="mt-3">
                            At Study Wander, we believe that education should be an adventure. We’re not just about helping you find a university – we’re here to guide you on a transformative journey to discover the
                            perfect academic destination that aligns with your goals, passions, and future
                            aspirations.
                        </p>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card one">
                                        <div class="testimonial-name">
                                            ...
                                            <!-- <img src="img/student/stu-one.png" style="width: 120px;" class="" alt=""> -->
                                        </div>
                                        <div class="testimonial-name-content">
                                            <div class="fw-bold">Sanya Kapoor</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card two">
                                        <div class="testimonial-name">
                                            ...
                                            <!-- <img src="img/student/stu-two.png" class="" style="width: 170px;" alt=""> -->
                                        </div>
                                        <div class="testimonial-name-content">
                                            <div class="fw-bold">Vikram Sharma</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card three">
                                        <div class="testimonial-name">
                                            ...
                                            <!-- <img src="img/student/stu-three.png" class="" style="width: 130px;" alt=""> -->
                                        </div>
                                        <div class="testimonial-name-content">
                                            <div class="fw-bold">Rohit Patel</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card one">
                                        <div class="testimonial-name">
                                            ...
                                            <!-- <img src="img/student/stu-four.png" class="" alt=""> -->
                                        </div>
                                        <div class="testimonial-name-content">
                                            <div class="fw-bold">Aditi Singh</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card five">
                                        <div class="testimonial-name">
                                            ...
                                            <!-- <img src="img/student/stu-five.png" class="" alt=""> -->
                                        </div>
                                        <div class="testimonial-name-content">
                                            <div class="fw-bold">Neha Desai</div>
                                            <p>London School of Economics</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="testimonial-card two">
                                        <div class="testimonial-name">
                                            ...
                                            <!-- <img src="img/student/stu-six.png" class="" style="width: 150px;" alt=""> -->
                                        </div>
                                        <div class="testimonial-name-content">
                                            <div class="fw-bold">Arjun Mehta</div>
        ...
        <section>
            <div class="container">
                <div class="title-con">
                    <h4>Destination</h4>
                    <h2>Universties In <span class="down">Country</span></h2>
                </div>
                ...
                <div class="row">
                            ...
                            <div class="service_img service_img-two">
                                ...
                                <div class="shape-one">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="243" height="201" viewBox="0 0 243 201" fill="none"
                                        data-inject-url="https://demo.ankdevelopment.in/education/4/assets/img/others/faq_shape01.svg" class="injectable tg-motion-effects4"
                                ...
                                <div class="shape-two">
                                    <span class="svg-icon" id="faq-two-svg" data-svg-icon="assets/img/others/faq_shape02.svg"><svg width="100%" height="100%" viewBox="0 0 54 66" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3.76256 36.4136C7.34334 29.8191 15.1459 14.2331 17.71 4.64484" stroke="#031333" stroke-width="3.07158" stroke-linejoin="round"
                                                style="stroke-dasharray: 35, 37; stroke-dashoffset: 0"></path>
                                            <path d="M18.1469 52.3203C25.5569 51.1365 42.6675 47.8153 51.8301 44" stroke="#031333" stroke-width="3.07158" stroke-linejoin="round"
                                                style="stroke-dasharray: 35, 37; stroke-dashoffset: 0"></path>
                                            <path d="M12.9399 41.2119C17.218 38.6967 26.7978 32.5534 30.8916 28.1021" stroke="#031333" stroke-width="3.07158" stroke-linejoin="round"
                                                style="stroke-dasharray: 23, 25; stroke-dashoffset: 0"></path>
                                        </svg></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-7 mt-4 mt-md-2">
                        <div class="service_wrap" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                            <div class="service_head">
                                <div class="service_icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="26" viewBox="0 0 32 26" fill="none"
                                        data-inject-url="https://demo.ankdevelopment.in/education/4/assets/img/icons/h2_features_icon01.svg" class="injectable">
                                        <path
                                            ...
                                            fill="white"></path>
                                        <path d="M30.75 15.161C30.0596 15.161 29.5 15.743 29.5 16.461V22.1C29.5 22.818 30.0596 23.4 30.75 23.4C31.4404 23.4 32 22.818 32 22.1V16.461C32 15.743 31.4404 15.161 30.75 15.161Z"
                                            fill="currentcolor"></path>
                                    </svg>
                                </div>
                                <span>
                            ...
                            <p>Dive into short-term academic and cultural experiences during your summer break. These programs allow you to earn credits while exploring new destinations, making the most of your time off.
                            </p>
                        ...
                        <div class="service_wrap" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                            <div class="service_head">
                                <div class="service_icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="32" viewBox="0 0 27 32" fill="none"
                                        data-inject-url="https://demo.ankdevelopment.in/education/4/assets/img/icons/h2_features_icon02.svg" class="injectable">
                                        <path
                            ...
                            <p>Immerse yourself in a new culture for an entire semester at one of our esteemed partner universities worldwide. Engage in coursework that enriches your major while experiencing life as a
                                local.</p>
                            <!-- <a href="" class="btn-one serv_btn">Know More <i class="fa-solid fa-chevron-right"></i></a> -->
                        ...
                        <div class="service_wrap" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                            ...
                            <p>Boost your language skills through intensive programs that combine classroom instruction with real-world practice. Experience local customs and traditions while becoming fluent in a new
                                language.</p>
                            <!-- <a href="" class="btn-one serv_btn">Know More <i class="fa-solid fa-chevron-right"></i></a> -->
                            <img src="img/svg/bg-stars.svg" alt="" class="service_shape" />
                        </div>
                ...
                <div class="row gy-4">
                    <div class="col-lg-5">
                        ...
                        <div class="d-flex gap-md-3 align-items-center flex-wrap">
                            <a href="https://studywander.edumilestones.com" target="_blank"><button class="btn-two">Apply Now<i class="fa-solid fa-chevron-right"></i></button></a>
                        </div>
                    </div>
                ...
                <div class="row mt-2 gy-4 justify-content-center">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="choose-us-card">
                            ...
                            <p>We provide personalized study abroad guidance, helping you select the right university & program based on your goals. Our expert counselors offer one-on-one support from applications to
                                visas.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="choose-us-card">
                            ...
                            <p>At Study Wander, our global network of top universities and industry experts offers exclusive opportunities, insights, and personalized recommendations to help you achieve your academic &
                                career goals.</p>
                        </div>
                    </div>
                ...
                <div class="flat-accordion m-auto row align-items-start">
                    <div class="col-lg-6 d-flex flex-column justify-content-between px-0 px-lg-3">
                        <div class="flat-toggle wow fadeInUp">
                            ...
                            <div class="toggle-content">
                                <p>
                                    Study Wander is a comprehensive study abroad platform that helps students find the best universities, scholarships, and programs that align with their academic and career goals. We
                                    provide personalized counseling, application assistance, and support for students looking
                        ...
                        <div class="flat-toggle wow fadeInUp">
                            ...
                            <div class="toggle-content">
                                <p>
                                    We offer expert guidance throughout your study abroad process, from selecting the right university to submitting applications, securing scholarships, and navigating visa requirements.
                                    Our services ensure a smooth, personalized journey tailored to your needs and
                                    aspirations.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flat-toggle wow fadeInUp">
                            ...
                            <div class="toggle-content">
                                <p>Study Wander offers many services, including personalized counseling and application assistance, at no charge to students. We are committed to making the study abroad process as
                                    accessible and affordable as possible.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp">
                            <h4 class="toggle-title">
                            ...
                            <div class="toggle-content">
                                <p>We help you identify and apply for relevant scholarships based on your academic profile and study destination. Our experts guide you through the scholarship application process to
                                    ensure you meet all deadlines and requirements.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            ...
                            <div class="toggle-content">
                                <p>The application timeline varies by university and program, but on average, it can take 2-6 months from researching universities to receiving your offer. Our team works efficiently to
                                    guide you through each step of the process to meet deadlines and secure your spot.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            <h4 class="toggle-title">
                            ...
                            <div class="toggle-content">
                                <p>Yes! We provide guidance on the visa application process for your chosen destination, ensuring you have the correct documentation and understand the requirements to secure your study
                                    visa.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            ...
                            <div class="toggle-content">
                                <p>
                                    Our expert counselors take the time to understand your academic interests, career goals, and personal preferences to recommend universities and programs that are the best fit for you.
                                    We offer insights into academic reputation, campus culture, financial aid options, and
                                    more.
                                </p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            ...
                            <div class="toggle-content">
                                <p>You will generally need academic transcripts, proof of English language proficiency (like IELTS or TOEFL), recommendation letters, a statement of purpose, and a resume or CV. Our team
                                    will guide you on which specific documents are required by each university.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            <h4 class="toggle-title">
                            ...
                            <div class="toggle-content">
                                <p>
                                    Once you’re accepted, Study Wander continues to support you by offering pre-departure services such as arranging accommodation, understanding your new cultural environment, and
                                    preparing you for your journey abroad. We ensure you feel confident and ready for the next
                        ...
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            ...
                            <div class="toggle-content">
                                <p>Absolutely! At Study Wander, we offer personalized counseling to help you assess if studying abroad aligns with your academic and career goals. Our experts will walk you through the
                                    benefits, challenges, and opportunities to ensure you make an informed decision.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-between px-0 px-lg-3">
                        <div class="flat-toggle wow fadeInUp">
                            ...
                            <div class="toggle-content">
                                <p>
                                    We understand that picking the right country and university can be overwhelming. Our team will help you evaluate your options based on your course of interest, career goals, budget,
                                    and lifestyle preferences. We guide you through researching programs, universities, and
                        ...
                        <div class="flat-toggle wow fadeInUp">
                            ...
                            <div class="toggle-content">
                                <p>
                                    Financial concerns are common, but don’t worry—Study Wander helps you identify scholarships, financial aid options, and affordable universities. We also provide tips on budgeting and
                                    managing your finances while studying abroad so you can pursue your dreams without
                                    breaking the bank.
                                </p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp">
                            ...
                            <div class="toggle-content">
                                <p>Our experts will guide you step-by-step through the entire process, from understanding entry requirements (like grades, tests, and language proficiency) to submitting the correct
                                    documentation. We make sure you’re fully prepared and never miss a deadline.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp">
                            <h4 class="toggle-title">
                            ...
                            <div class="toggle-content">
                                <p>
                                    We help you explore your options based on your interests, skills, and career goals. Our counselors will discuss your passions and academic strengths, helping you choose a course that
                                    aligns with your future aspirations and makes the most of your study abroad experience.
                                </p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp">
                            ...
                            <div class="toggle-content">
                                <p>It’s totally normal to feel overwhelmed. Study Wander offers hands-on support throughout the entire application process. From university research to preparing documents and filling out
                                    forms, we guide you every step of the way so you never feel lost.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            <h4 class="toggle-title">
                            ...
                            <div class="toggle-content">
                                <p>We provide pre-departure orientation, including advice on cultural differences, accommodation, and settling into your new environment. Our team also offers ongoing support during your
                                    time abroad, helping you adapt smoothly and confidently.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            <h4 class="toggle-title">
                            ...
                            <div class="toggle-content">
                                <p>The timeline can vary depending on your chosen university and course, but generally, it takes about 3-6 months to complete the application process. We’ll help you stay organized and
                                    meet all deadlines to ensure a smooth, timely application.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            <h4 class="toggle-title">
                            ...
                            <div class="toggle-content">
                                <p>While rejections can be tough, we’re here to help you explore backup options and find alternative universities that may be a better fit. We can help you adjust your application strategy
                                    or recommend other universities that offer similar programs.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            <h4 class="toggle-title">
                            ...
                            <div class="toggle-content">
                                <p>We offer personalized, one-on-one consultations to thoroughly understand your goals, concerns, and preferences. We’re committed to providing expert advice based on your unique
                                    situation, helping you feel confident in your study abroad decision.</p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            <h4 class="toggle-title">
                            ...
                            <div class="toggle-content">
                                <p>
                                    Yes! The visa process can seem complicated, but our team will guide you through the requirements and help you gather the necessary documents. We ensure you understand the entire
                                    process, including visa interviews and travel arrangements, so you can study abroad without
                                    stress.
                                </p>
                            </div>
                        </div>
                        <div class="flat-toggle wow fadeInUp" x-show="show">
                            ...
                            <div class="toggle-content">
                                <p>
                                    That’s completely okay! We want you to make a choice that feels right for you. If you’re still unsure, we can arrange additional sessions to clarify your doubts, offer more
                                    information, and even discuss alternative education options. We’re here to support you no matter
