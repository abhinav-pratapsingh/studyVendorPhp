...
<html lang="en">
   <head>
      ...
      <style>
         ...
         .herosec-con .video_container video {
            width: auto;
            height: 100%;
         }
      </style>
   ...
   <body>
      ...
      <main>
               ...
               <div class="container h-100">
                  <div class="row h-100 align-items-center">
                     <div class="col-lg-6">
                        ...
                        <a href="https://careertest.edumilestones.com/student-profiler/?channel_id=MzMxOQ==" target="_blank">
         ...
         <section class="bg-gray about_sec">
            <div class="container">
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-7">
                     ...
                     <a href="" class="btn-two">Know More <i class="ph-bold ph-arrow-up-right"></i></a>
                  </div>
               </div>
            </div>
         </section>
         ...
         <section>
            <div class="container">
               <div class="title-con text-start d-flex align-items-center justify-content-between">
                  ...
                  <a href="" target="_blank" class="d-none d-md-inline">View All Countries <i class="fa fa-arrow-right-long"></i></a>
               </div>
