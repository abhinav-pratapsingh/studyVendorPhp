...
<div class="offcanvas offcanvas-start d-xl-none" tabindex="-1" id="nav-canvas" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-header" style="border-bottom: 1px solid rgba(128, 128, 128, 0.198)">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel"><img src="../img/logo.png" width="90px" class="rounded-2" alt="" /></h5>
    ...
    <div class="offcanvas-body">
        <div>
            <ul class="small-nav-con">
                ...
                <li><a href="https://studywander.edumilestones.com">Study Abroad</a></li>
                ...
                <div x-data="{show : false}">
                    ...
                    <div x-show="show" x-transition class="destination-con mobile-nav">
                        ...
                        <a href="usa" class="flag-con d-flex gap-4">
                            <img src="../img/flag/usaFlag.jpg" alt="" />

                            <div>USA</div>
                        </a>
                        <a href="uk" class="flag-con d-flex gap-4">
                            <img src="../img/flag/ukFlag.jpg" alt="" />
                            <div>UK</div>
                        </a>
                        <a href="canada" class="flag-con d-flex gap-4">
                            <img src="../img/flag/canadaFlag.jpg" alt="" />
                            <div>Canada</div>
                        </a>
                        <a href="australia" class="flag-con d-flex gap-4">
                            <img src="../img/flag/australiaFlag.jpg" alt="" />
                            <div>Australia</div>
                        </a>
                        <a href="new-zealand" class="flag-con d-flex gap-4">
                            <img src="../img/flag/newzealandFlag.jpg" alt="" />
                            <div>New Zealand</div>
                        </a>
                        <a href="germany" class="flag-con d-flex gap-4">
                            <img src="../img/flag/germanyFlag.jpg" alt="" />
                            <div>Germany</div>
                        </a>
                        <a href="ireland" class="flag-con d-flex gap-4">
                            <img src="../img/flag/irelandFlag.jpg" alt="" />
                            <div>Ireland</div>
                        </a>
                        <a href="france" class="flag-con d-flex gap-4">
                            <img src="../img/flag/franceFlag.png" alt="" />
                            <div>France</div>
                        </a>
                        <a href="singapore" class="flag-con d-flex gap-4">
