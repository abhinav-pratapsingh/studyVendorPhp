<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (mysqli_query($con, $query)) {
            $form_alert = "<script>alert('Successfully Registered');window.location.href='contact-us';</script>";
        } else {
            $form_alert = "<script>alert('Failed to register: " . mysqli_error($con) . "');</script>";
        }
    }
?>
<!DOCTYPE html>
            ...
            <div class="container">
               <div class="contact-us-con-wrapper">
                  <div class="contact-us-col-1 d-lg-block d-none">
                     <img src="img/images/contact-img.jpg" alt="" />
                  </div>
